...
QString Game::getPictureSelected(){
    return pictureSelected;
}

void Game::setPictureSelected(QString newSelected){
    pictureSelected = newSelected;
}
bool Game::couldBeLinked(QString o1, QString o2){
    QString pos2, pos3;
    return (linkWithNoCorner(o1,o2) || linkWithOneCorner(o1,o2,pos2) || linkWithTwoCorner(o1,o2,pos2,pos3));
}
